...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Active style function for clicked features
    ...
    function resetStyle(layer, count) {
        return {
            fillColor: getColor(count),
            weight: 1,
            opacity: 1,
    ...
    function handleHover(e, feature, count) {
        var layer = e.target;
    ...
    function handleMouseOut(e, feature, count) {
        var layer = e.target;
        if (layer !== activeLayer) {
            layer.setStyle({
                weight: 1,
    ...
    function createChoroplethLayer(geoJson, type) {
        return L.geoJSON(geoJson, {
            ...
            onEachFeature: function (feature, layer) {
                ...
                layer.on({
                    mouseover: (e) => handleHover(e, feature, count),
                    mouseout: (e) => handleMouseOut(e, feature, count),
